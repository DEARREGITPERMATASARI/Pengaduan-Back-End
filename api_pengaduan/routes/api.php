...
Route::group(['middleware' => ['jwt.verify:admin']], function () { //untuk hak akses admin dan petugas
    ...
    Route::post('masyarakat', [LoginController::class, 'register']); //get all
	// Route::get('masyarakat/{id_user}', [MasyarakatController::class, 'getById']); //get all
	Route::get('masyarakat/{limit}/{offset}', [MasyarakatController::class, 'getAll']); //get all dengan limit
    Route::put('masyarakat/{id}', [LoginController::class, 'update']); //update
    Route::delete('masyarakat/{id}', [MasyarakatController::class, 'delete']); //delete
    ...
    Route::put('petugas/{id}', [PetugasController::class, 'update']); //update
    Route::delete('petugas/{id}', [PetugasController::class, 'delete']); //delete
...
Route::group(['middleware' => ['jwt.verify:masyarakat']], function () { //untuk hak akses masyarakat
    ...
    Route::put('masyarakat/pengaduan/{id_pengaduan}', [PengaduanController::class, 'update']); //update
    Route::get('masyarakat/kategori', [KategoriController::class, 'getAll']); //get all
